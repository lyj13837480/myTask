...
var DemoMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"add\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"sum\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
// Sum is a free data retrieval call binding the contract method 0x853255cc.
//
// Solidity: function sum() view returns(uint256)
func (_Demo *DemoCaller) Sum(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Demo.contract.Call(opts, &out, "sum")
...
//
// Solidity: function sum() view returns(uint256)
func (_Demo *DemoSession) Sum() (*big.Int, error) {
	return _Demo.Contract.Sum(&_Demo.CallOpts)
}

// Sum is a free data retrieval call binding the contract method 0x853255cc.
//
// Solidity: function sum() view returns(uint256)
func (_Demo *DemoCallerSession) Sum() (*big.Int, error) {
	return _Demo.Contract.Sum(&_Demo.CallOpts)
}
